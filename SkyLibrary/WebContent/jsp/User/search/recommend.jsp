				...
				<div class="section">
					...
					<div class="content">
						...
						{					
							...
							//도서 갯수 조회
							sql = "select count(*) as cnt from rbook ";
							...
							//한페이지에 올릴 도서 정보 조회
							sql = "select * from book where isbn in (select isbn from rbook) ";
								...
								<table width="800px">
									<tr>
										<td rowspan="3" width="20%" align="center">
											<a href="recommendView.jsp?isbn=<%= visbn %>"><img src="<%= vcoverimg %>" alt="<%= vsubject %>"></a>
										</td>
										<td colspan="2"><a href="recommendView.jsp?isbn=<%= visbn %>"><b><%= vsubject %></b></a></td>
									</tr>
									<tr>
										<td colspan="2"><%= vstory %></td>
									</tr>
									<tr>
										<td width="40%">저자 : <%= vwriter %></td>
										<td>출판사 : <%= vcompany %></td>
									</tr>
								</table>
							</div>
